/* Ícones em SVG inline (linha, estilo Lucide) — substituem os emojis.
   Uso: icone("residentes")  ou  icone("residentes", 20)
   Os ícones herdam a cor do texto (currentColor) e o tamanho informado. */
...
const TRACOS = {
  ...
  "olho-fechado":
    '<path d="M10.73 5.08A10.43 10.43 0 0 1 12 5c7 0 10 7 10 7a13.16 13.16 0 0 1-1.67 2.68"/><path d="M6.61 6.61A13.526 13.526 0 0 0 2 12s3 7 10 7a9.74 9.74 0 0 0 5.39-1.61"/><path d="m2 2 20 20"/><path d="M14.12 14.12a3 3 0 1 1-4.24-4.24"/>',
};

export function icone(nome, tamanho = 18) {
  const tracos = TRACOS[nome];
  if (!tracos) return "";
  return `<svg class="icone-svg" width="${tamanho}" height="${tamanho}" viewBox="0 0 24 24" `
